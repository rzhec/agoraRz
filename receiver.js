...
socket.addEventListener('message', function (event) {
    ...
    // console.log('check prerequisite',rFlag, initParams)
    if (rFlag && message && message.channel && message.tokenB){
        ...
        if(r == true){
            ...
            document.getElementById('token').value = initParams.token;
...
function join (rtc, option) {
     ...
     **/
    // console.log('option',option.mode, option.codec)
